...
function Resume() {
  ...
  return (
    ...
    <input style={{width:"81%",paddingTop:"10px", paddingBottom:"10px", paddingLeft:"15px", 
    paddingRight:"10px", border:"2px solid white"}} 
    placeholder="Enter Github Username" type="text" value={userInput} onChange={handleSearch}/>

    <button style={{fontWeight:"bold", border:"2px solid white", background:"#010409", 
    color:"white",padding:"10px", paddingRight:"10px", letterSpacing:"0.5px"}} 
    type="submit" onClick={handleSubmit}>Submit</button>
                
    { error ? (<h3 style={{margin:"25px"}}>{error}</h3>) : (

      <div>
        <img src={avatar_url} alt={avatar_url} style={{width:"100px", borderRadius:"50%", 
        marginTop:"20px"}}></img>
        ...
        <div style={{backgroundColor:"#8074ac", color:"white", paddingTop:"2px", 
        paddingBottom:"4px", marginTop:"10px"}}>
